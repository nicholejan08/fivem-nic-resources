...
------
-- RegisterNetEvent PlaySound:PlayOnOne
--
...
------
RegisterNetEvent('PlaySound:PlayOnOne')
AddEventHandler('PlaySound:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
RegisterNetEvent('PlaySound:PlayThenStop')
AddEventHandler('PlaySound:PlayThenStop', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSoundStop',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
    })
end)

RegisterNetEvent('StopSound:StopCurrentSound')
AddEventHandler('StopSound:StopCurrentSound', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
-- RegisterNetEvent PlaySound:PlayOnAll
--
-- @param soundFile    - The name of the soundfile within the client/html/sounds/ folder.
--                     - Can also specify a folder/sound file.
-- @param soundVolume  - The volume at which the soundFile should be played. Nil or don't
...
------
RegisterNetEvent('PlaySound:PlayOnAll')
AddEventHandler('PlaySound:PlayOnAll', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSound',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
...
------
-- RegisterNetEvent PlaySound:PlayWithinDistance
--
...
------
RegisterNetEvent('PlaySound:PlayWithinDistance')
AddEventHandler('PlaySound:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
